<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMst.master" AutoEventWireup="true" CodeBehind="EmployeeAttendance.aspx.cs" Inherits="UniversityManegementSystem.Admin.EmployeeAttendance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="container p-md-4 p-sm-4">
            ...
            <h2 class="text-center">Посещаемость преподавателей</h2>
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
             ...
             <div class="row mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-6 col-lg-4 col-xl-3 col-md-offset-2 mb-3">
                    <asp:Button ID="btnMarkAttendance" runat="server" CssClass="btn btn-primary btn-block" BackColor="#32DFA5" Text="Mark Attendance" 
